...
export function FlowButton({ text = 'Submit' }: { text?: string }) {
  return (
    ...
    >
      ...
      <LogIn className="absolute w-4 h-4 right-4 stroke-[#ffffff] fill-none z-[9] group-hover:right-[-25%] group-hover:stroke-white transition-all duration-[800ms] ease-[cubic-bezier(0.34,1.56,0.64,1)]" />
    </button>
  );
}
