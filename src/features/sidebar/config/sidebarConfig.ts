...
import { Calendar, PlusCircle, Car, MapPin, Map, LayoutGrid, Package, Star, MessageSquare, ShieldCheck, UserCircle, LayoutDashboard, User, DollarSign, ClipboardList, Users, TrendingUp, Bell, ShoppingCart, Sparkles, Home, FileEdit } from 'lucide-react';
...
export const bookingsGroup: NavGroup = {
  ...
  items: [
    ...
    { label: 'Custom Tour Requests',  href: '/custom-bookings',  icon: FileEdit },
  ],
};
...
export const packagesGroup: NavGroup = {
  ...
  items: [
    ...
    { label: 'Featured Packages', href: '/admin/packages/featured', icon: Star },
    { label: 'Create Package', href: '/admin/packages/create', icon: PlusCircle },
  ],
};
...
export const adminGroup: NavGroup = {
  ...
  items: [
    ...
    { label: 'Custom Tour Requests',  href: '/admin/custom-bookings',  icon: FileEdit },
